...
class Coffee {
  ...
  String getTotalPrice(Coffee coffee, Coffee milk, Coffee syrup) {
    if (ice == 1) {
      return ((coffee.price + milk.price + syrup.price) + 0.5).toStringAsFixed(2);
    }
    return (coffee.price + milk.price + syrup.price).toStringAsFixed(2);
  }
}
